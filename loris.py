...
from utils import check_domain_validity, prepare_headers
...
class Downloader:
    ...
    def _download_video(self, video):
        ...
        try: 
            wget.download(url, out=re.sub(r'[^\w_.)( -]', '', output_file))
        except Exception as ex:
            print('\x1b[6;30;42m' +'Zzz Ops: server session got problem on: ' + title + '\x1b[0m')
